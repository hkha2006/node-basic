...
var builUrlEmail = function builUrlEmail(doctorId, token) {
  var result = "".concat(process.env.URL_REACT, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};
var postBookAppoinment = function postBookAppoinment(data) {
...
var postVerifyAppoinment = function postVerifyAppoinment(data) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 12:
            resolve({
              errCode: 0,
              errMessage: 'Update an appointment succeed!!!'
            });
            _context2.next = 16;
            break;
          case 15:
