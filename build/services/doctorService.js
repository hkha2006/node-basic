...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var arrFields = ['doctorId', 'contentHTML', 'contentMarkdown', 'actions', 'selectedPrice', 'selectedPayment', 'selectedProvince', 'nameClinic', 'addressClinic', 'note', 'specialtyId'];
  var isValid = true;
  var element = '';
...
var saveInforDoctor = function saveInforDoctor(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var checkObject, doctorMarkdown, doctorInfor;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              errMessage: "Missing para: ".concat(checkObject.element)
            });
            _context3.next = 42;
            break;
          case 6:
...
var sendRedemy = function sendRedemy(data) {
  return new Promise( /*#__PURE__*/function () {
