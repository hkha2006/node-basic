      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"DangHoangKha 👻" <danghoangkha2006@gmail.com>',
            // sender address
...
var getBodyHTMLRedemy = function getBodyHTMLRedemy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return transporter.sendMail({
            ...
            attachments: [{
              filename: "redemy-".concat(dataSend.patientId, "-").concat(new Date().getTime(), ".png"),
