...
var _patientCotroller = _interopRequireDefault(require("../controllers/patientCotroller"));
...
var initWebRoutes = function initWebRoutes(app) {
  ...
  router.post('/api/send-redemy', _doctorController["default"].sendRedemy);
  router.post('/api/patient-book-appointment', _patientCotroller["default"].postBookAppoinment);
  router.post('/api/verify-book-appointment', _patientCotroller["default"].postVerifyAppoinment);
  router.post('/api/create-new-specialty', _specialtyController["default"].createSpecailty);
  ...
  router.get('/api/get-all-handbooks', _handbookController["default"].getAllHandbooks);
  ...
  router.get('/api/get-detail-clinic-by-id', _clinicController["default"].getDetailClinictyById);
